...
FactoryGirl.create(:featured_listing, image: File.open(File.join(Rails.root, "/db/data/sample_house.jpg")))
FactoryGirl.create(:listing, image: File.open(File.join(Rails.root, "/db/data/sample_house.jpg")))
FactoryGirl.create(:listing, status: 'for_rent', image: File.open(File.join(Rails.root, "/db/data/sample_house.jpg")))
FactoryGirl.create(:listing, status: 'sold', image: File.open(File.join(Rails.root, "/db/data/sample_house.jpg")))
FactoryGirl.create(:listing, status: 'sold', image: File.open(File.join(Rails.root, "/db/data/sample_house.jpg")))
